...
namespace is_takibi
{
    public partial class CDguncelle : Form
    {
        public CDguncelle()
        {
            InitializeComponent();
        ...
        private void CDguncelle_Load(object sender, EventArgs e)
        {
        ...
        private void guncelle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                CalisanDepo cccc = (CalisanDepo)Application.OpenForms["CalisanDepo"]; // diğer formun (Form4'ün) otomatik güncellenmesi için ;)
