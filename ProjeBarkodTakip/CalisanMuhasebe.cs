...
namespace is_takibi
{
    public partial class CalisanMuhasebe : Form
    {
        public CalisanMuhasebe()
        {
            InitializeComponent();
        }
        ...
        public void muhasebe_dok()
        {
            ...
            //son Bir hafta için gerekli süreler belirleniyor
...
*/
        ...
        public void kullanici_belirle()
        {
            ...
            if (dr.Read())
            {
                label15.Text = dr["c_isim"].ToString();
        ...
        private void CalisanMuhasebe_Load(object sender, EventArgs e)
        {
        ...
        private void guncelle_Click(object sender, EventArgs e)
        {
            ...
            CmuhGuncelle form12 = new CmuhGuncelle();
        ...
        private void muhasebe_Click(object sender, EventArgs e)
        {
            ...
            CalisanMuhasebe CalisanMuhasebe = new CalisanMuhasebe();
            CalisanMuhasebe.oturum_id2 = oturum_id2;

            CalisanMuhasebe.Show();
