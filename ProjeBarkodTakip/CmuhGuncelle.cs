...
namespace is_takibi
{
    public partial class CmuhGuncelle : Form
    {
        public CmuhGuncelle()
        {
            InitializeComponent();
        ...
        private void CmuhGuncelle_Load(object sender, EventArgs e)
        {
            baglan.Open();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                CalisanMuhasebe f11 = (CalisanMuhasebe)Application.OpenForms["CalisanMuhasebe"]; // diğer formun (Form2'nin) otomatik güncellenmesi için ;)
                f11.muhasebe_dok();
