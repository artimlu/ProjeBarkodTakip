...
namespace is_takibi
{
    public partial class Depo: Form
    {
        ...
        {
            if (isim.Text.Length == 0 ||  mail.Text.Length == 0   )
            {
            ...
            else
            {
                ...
                MySqlCommand ekle = new MySqlCommand("INSERT INTO depo (d_urun,d_adet,d_tarih,d_aciklama) VALUES (@m_isim,@m_mail,@m_tarih,@aciklama)", baglan);

                ekle.Parameters.AddWithValue("@m_isim", isim.Text);

                ekle.Parameters.AddWithValue("@aciklama", d_aciklamaT.Text);
        ...
        private void depo_sil_Click(object sender, EventArgs e)
        {
            DialogResult secenek = MessageBox.Show("Bu Ürünü Depodan Silmek istiyor musunuz?", "Depo Silme Penceresi", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        ...
        private void depo_guncelle_Click(object sender, EventArgs e)
        {
            ...
            DepoGuncelle cdgg = new DepoGuncelle();
