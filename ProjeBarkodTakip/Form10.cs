...
namespace is_takibi
{
    public partial class Form10 : Form
    {
        ...
        private void guncelle_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Çalışan Adını Doldurunuz!");
            }
            ...
            else
            {
                ...
                guncelleww.Parameters.AddWithValue("@tcc", tc_noo.Text);
                ...
                Form9 f9 = (Form9)Application.OpenForms["Form9"]; // diğer formun (Form2'nin) otomatik güncellenmesi için ;)
                f9.cal_dok();
