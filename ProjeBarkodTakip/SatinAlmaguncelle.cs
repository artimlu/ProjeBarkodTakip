...
namespace is_takibi
{
    public partial class SatinAlmaguncelle : Form
    {
        public SatinAlmaguncelle()
        {
            InitializeComponent();
        }
        ...
        private void SatinAlmaguncelle_Load(object sender, EventArgs e)
        {
        ...
        private void guncelle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SatinAlma ccc = (SatinAlma)Application.OpenForms["SatinAlma"]; // diğer formun (Form4'ün) otomatik güncellenmesi için ;)
                ccc.mus_dok_satin_alma();
