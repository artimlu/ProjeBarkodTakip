...
namespace is_takibi
{
    public partial class Takip : Form
    {
        ...
        private void Takip_Load(object sender, EventArgs e)
        {
            ...
            dataGridViewTakip.DataSource = ds.Tables[0];
        ...
        private void dataGridViewTakip_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            //datagrid özellikleri

            dataGridViewTakip.Columns["t_id"].Visible = false; // datagrid de is_id kolonunu göstermiyoruz ;)


            dataGridViewTakip.Columns[0].Width = 60; // sütun genişliği ayarlama


            dataGridViewTakip.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill; // otomatik kaplama
        }
